...
Emacs comes with plenty of pre-installed themes. As of lately, I use
the [[https://protesilaos.com/emacs/modus-themes][Modus themes]]. They are designed for accessible readability and
conform with the highest standard for color contrast between
combinations of background and foreground values.
...
This is something that I do /very/ often. Lines can be moved down
using =M-n= or up using =M-p=. Can be prefixed to move the current
line multiple lines up or down.
...
[[https://github.com/dominikh/go-mode.el][go-mode]] is an emacs mode for the Go programming language .
